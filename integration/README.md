...
command = "/home/ian/.local/bin/noctalia-taildrop %f"
types = ["*"]
```
...
<actions>
  <action>
    ...
    <command>/home/ian/.local/bin/noctalia-taildrop %F</command>
...
```sh
/home/ian/.local/bin/noctalia-taildrop <selected-files-placeholder>
```
